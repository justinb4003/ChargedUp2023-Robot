...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    chooser.addOption("Right Five Ball Red", new RightThreeAtATimeRed());
    chooser.addOption("Right Five Ball Blue", new RightFiveBall3ThreeAtOnce());
  ...
  public Command getAutonomousCommand() {
    ...
    //m_autoCommand = new CurvyRightFiveBall();
    //m_autoCommand = new RightFiveBall3ThreeAtOnce();
